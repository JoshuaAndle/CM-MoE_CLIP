...
"""
A wrapper class for memory buffers which allows task-wise separation of buffers for organizational purposes
Provides functions for merging and resizing buffers to maintain memory constraints as tasks are consolidated

"""
class Multitask_Memory:
    def __init__(self, args, data_source: Dataset=None) -> None:
        ...
        self.cls_count_by_task = {}
        self.total_memory = args.get("memory_size", 0)

    def add_new_buffer(self, class_count: int) -> None:
